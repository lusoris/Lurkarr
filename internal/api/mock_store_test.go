...
func (m *MockStore) CreateSplitSeasonRule(ctx context.Context, r database.SplitSeasonRule) (*database.SplitSeasonRule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSplitSeasonRule", ctx, r)
	ret0, _ := ret[0].(*database.SplitSeasonRule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CreateSplitSeasonRule indicates an expected call of CreateSplitSeasonRule.
func (mr *MockStoreMockRecorder) CreateSplitSeasonRule(ctx, r any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateSplitSeasonRule", reflect.TypeOf((*MockStore)(nil).CreateSplitSeasonRule), ctx, r)
}
...
// DeleteSplitSeasonRule mocks base method.
func (m *MockStore) DeleteSplitSeasonRule(ctx context.Context, id uuid.UUID) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteSplitSeasonRule", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// DeleteSplitSeasonRule indicates an expected call of DeleteSplitSeasonRule.
func (mr *MockStoreMockRecorder) DeleteSplitSeasonRule(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteSplitSeasonRule", reflect.TypeOf((*MockStore)(nil).DeleteSplitSeasonRule), ctx, id)
}
...
func (m *MockStore) IncrementFailedLogins(ctx context.Context, id uuid.UUID, maxAttempts int, lockDuration time.Duration) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "IncrementFailedLogins", ctx, id, maxAttempts, lockDuration)
	ret0, _ := ret[0].(error)
	return ret0
}
...
func (m *MockStore) ListSplitSeasonRules(ctx context.Context, groupID uuid.UUID) ([]database.SplitSeasonRule, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ListSplitSeasonRules", ctx, groupID)
	ret0, _ := ret[0].([]database.SplitSeasonRule)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ListSplitSeasonRules indicates an expected call of ListSplitSeasonRules.
func (mr *MockStoreMockRecorder) ListSplitSeasonRules(ctx, groupID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ListSplitSeasonRules", reflect.TypeOf((*MockStore)(nil).ListSplitSeasonRules), ctx, groupID)
}
...
func (m *MockStore) ResetFailedLogins(ctx context.Context, id uuid.UUID) error {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) ResetFailedLogins(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResetFailedLogins", reflect.TypeOf((*MockStore)(nil).ResetFailedLogins), ctx, id)
}
